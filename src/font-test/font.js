(function(window, document, undefined) {
    ...
    function ba(a, b) {
        var c = a.split("."),
        d = aa; ! (c[0] in d) && d.execScript && d.execScript("var " + c[0]);
    ...
    function D(a) {
        ...
        if ("" != b) return /BB\d{2}/.test(b) && (b = "BlackBerry"),
        b;
    ...
    function J(a, b, c) {
        if (a.M[b]) if (c) a.M[b](c.getName(), I(c));
        else a.M[b]()
    };
    function L(a, b) {
        this.c = a;
    ...
    function ta(a, b, c, d, e) {
        if (0 === b.length && e) K(a.t);
            ...
            for (e = 0; e < b.length; e++) {
                ...
                J(h, "fontloading", n); (new qa(s(a.ha, a), s(a.ia, a), a.c, f, a.k, a.S, d, g)).start()
            }
        }
    }
    ...
    S.prototype.ua = function(a, b, c, d) {
        ...
        d ? a.load(function(a, d, h) {
            ...
            0)
        }) : (a = 0 == --this.P, this.O--, a && (0 == this.O ? K(b) : pa(b)), ta(c, [], {},
        l, a))
    };
    var va = window,
    wa = (new C(navigator.userAgent, document)).parse(),
    U = va.WebFont = new S(window, new
    function() {
        this.$ = {}
    },
    wa);
    ...
    V.prototype.load = function(a) {
        ...
        for (c = e.length; b < c; b++) {
            var f = e[b].split(":");
            if (f[1]) for (var g = f[1].split(","), h = 0; h < g.length; h += 1) d.push(new H(f[0], g[h]));
    ...
    W.prototype.load = function(a) {
        ...
        for (var b = this.d.families,
        c = [], d = 0, e = b.length; d < e; d++) c.push.apply(c, ya(b[d]));
        a(c)
    };
    function ya(a) {
        var b = a.split(":");
        ...
        c ? (e.__webfonttypekitmodule__ || (e.__webfonttypekitmodule__ = {}), e.__webfonttypekitmodule__[c] = function(c) {
            ...
            function(a, c, d) {
                for (var e = 0; e < c.length; e += 1) {
                    var g = d[c[e]];
                    if (g) for (var Q = 0; Q < g.length; Q += 1) f.m.push(new H(c[e], g[Q]));
    ...
    za.prototype.f = function() {
        ...
        for (var a = this.p.length,
        b = [], c = 0; c < a; c++) b.push(this.p[c].replace(/ /g, "+"));
    ...
    Z.prototype.X = function(a) {
        for (var b = this.c,
        c = new za(this.d.api, x(b), this.d.text), d = this.d.families, e = d.length, f = 0; f < e; f++) {
            var g = d[f].split(":");
