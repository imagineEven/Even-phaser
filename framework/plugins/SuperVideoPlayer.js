...
class SuperVideoPlayer {
  ...
  setXAnchor(anchorX) {
    if (this.player instanceof Phaser.Sprite) {
      ...
      Object.assign(this.playerStyles, {
        left: offsetx + 'px',
      });
  ...
  [Symbol.for('createPlusVPlayer')]() {
    ...
    this.playerStyles = {
      ...
      'show-play-btn': false, //不自动播放时显示播放按钮
      'show-center-play-btn': false,
      'enable-progress-gesture': false
    };

    this.videoContainer = $('<div id="videoplayer"></div>').css({
      position: 'absolute',
      top: `${offsety}px`,
      left: `${offsetx}px`,
    ...
    this.player = new plus.video.VideoPlayer(
      'videoplayer', this.playerStyles
    );
