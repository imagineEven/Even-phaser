...
function load() {
  ...
  Phaser.Filter.Dark = function(game) {
    ...
    this.fragmentSrc = [
      ...
      'gl_FragColor.rgb = mix(gl_FragColor.rgb, vec3(0.3 * gl_FragColor.r + 0.3 * gl_FragColor.g + 0.3 * gl_FragColor.b), dark);',
      '}'
    ];
  ...
  Phaser.Filter.Dark.prototype.forEachPixel = (pixel) => {
    let newColor = (pixel.r * 0.3 + pixel.g * 0.3 + pixel.b * 0.3);
    pixel.r = newColor;
    pixel.g = newColor;
    pixel.b = newColor;
    return pixel;
